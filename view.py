...
class CalculatorView(QWidget): 
 ...
 self.input_field.setStyleSheet("font-size: 24px; background-color: #000; 
color: #fff; border: none;") 
self.input_field.setAlignment(Qt.AlignRight) 
 grid_layout.addWidget(self.input_field, 0, 0, 1, 4) 
 # Define button labels, their positions in the grid, and background 
colors 
 buttons = [ 
...
'#e18f14'), ('-', 3, 3, '#2196F3'), 
 ('0', 4, 0, '#e18f14'), ('C', 4, 1, '#FF5722'), ('=', 4, 2, '#fff'), 
('+', 4, 3, '#2196F3') 
 ] 
...
background-color: {color}; color: {'#000' if button_text == '=' else '#fff'}; 
